  ...
  return (
    <>
      <div className={styles.header}>
        <div className={styles.logo}>ShepherdThemes</div>
        <div className={styles.links}>
          <a className={styles.link} href="https://shepherdjs.dev/">
            <img
              className={styles.logoImage}
              src="/shepherd-logo.png"
              alt="shepherd logo"
            />
            <h5 className={styles.logoName}>Shepherdjs</h5>
          </a>
          <a className={styles.link} href="https://github.com/shubham-gundgire/shepherd-themes">
            <svg
             className={styles.logoImage}
              stroke="currentColor"
              fill="currentColor"
            ...
            <h5 className={styles.logoName}>ShepherdThemes</h5>
          </a>
        </div>
      </div>
    </>
